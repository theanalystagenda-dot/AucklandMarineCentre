...
const brands = [
  'KiwiKraft', 'Challenger', 'FlyFin', 'Fi-Glass',
  'AMC Boats', 'Campion', 'Reflex', 'Senator',
  'Fyran', 'Legacy SLR', 'Mercury', 'Suzuki',
]
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              {quickLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-silver-mid hover:text-white transition-colors duration-150">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              {brands.map((b) => (
                <li key={b} className="text-sm text-silver-mid">{b}</li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <address className="not-italic flex flex-col gap-2 text-sm text-silver-mid">
              ...
              <a href="tel:0927111575" className="hover:text-white transition-colors">09 271 1575</a>
              <a href="mailto:sales@aucklandmarine.co.nz" className="hover:text-white transition-colors">sales@aucklandmarine.co.nz</a>
              <a href="mailto:service@aucklandmarine.co.nz" className="hover:text-white transition-colors">service@aucklandmarine.co.nz</a>
            </address>
            <div className="mt-4">
