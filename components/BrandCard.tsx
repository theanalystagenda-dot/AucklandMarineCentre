...
export default function BrandCard({ brand, href }: BrandCardProps) {
  return (
    <Link
      href={href}
      className="flex flex-col items-center text-center p-6 rounded-xl border border-transparent hover:border-silver-mid bg-white hover:shadow-sm transition-all duration-200 group"
    >
      <div className="w-20 h-20 bg-silver rounded-xl flex items-center justify-center mb-4">
