...
const values = [
  { icon: '🏆', title: 'Expertise', desc: 'Over 35 years of specialist marine knowledge. Our team has seen — and fixed — everything.' },
  { icon: '🔧', title: 'Certified Service', desc: 'Mercury and Suzuki factory-certified. Your engine gets the same treatment as a brand-new warranty job.' },
  { icon: '🚤', title: 'Range', desc: '75+ models from 11 leading brands — all in stock. We&apos;re not a catalogue, we&apos;re a showroom.' },
  { icon: '🤝', title: 'After-Sales', desc: 'The relationship doesn&apos;t end at the sale. Parts, service, upgrades — we&apos;re here for the life of your boat.' },
]
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((v) => (
                <div key={v.title} className="flex flex-col items-center text-center p-6 bg-silver rounded-xl">
                  <span className="text-4xl mb-4" aria-hidden="true">{v.icon}</span>
