        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-20">
            <div>
              ...
              <div className="flex flex-col gap-4 text-charcoal leading-relaxed max-w-prose text-[15px]">
                <p>
            ...
            <div className="bg-charcoal aspect-[4/3] relative overflow-hidden flex items-center justify-center">
              ...
              <div className="relative text-center text-white/20">
                <svg className="w-16 h-16 mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={0.75} aria-hidden="true">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
              {team.map((member) => (
                <div key={member.name} className="flex flex-col items-center text-center p-4 bg-silver border border-silver-mid">
                  <div className="w-16 h-16 bg-white border border-silver-mid flex items-center justify-center mb-3">
                    <svg className="w-8 h-8 text-silver-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((v) => (
                <div key={v.title} className="flex flex-col items-center text-center p-6 bg-silver border border-silver-mid">
                  <div className="w-12 h-12 bg-white border border-silver-mid flex items-center justify-center mb-4 text-ocean">
                    {v.icon}
                  </div>
                  <h3 className="font-display text-xl font-bold text-charcoal mb-2">{v.title}</h3>
                  <p className="text-sm text-silver-dark leading-relaxed">{v.desc}</p>
                </div>
              ))}
            </div>
          </div>
