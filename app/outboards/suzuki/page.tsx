      ...
      <div className="bg-suzuki-blue py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-3 h-10 bg-white" aria-hidden="true" />
            <h1 className="font-display text-5xl lg:text-6xl font-bold text-white tracking-tight">Suzuki Outboards</h1>
          </div>
      ...
      <div className="py-12 bg-silver">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((model) => (
              <div key={model.name} className="bg-white border border-silver-mid hover:border-suzuki-blue/30 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 overflow-hidden flex flex-col group">
                <div className="h-0.5 bg-suzuki-blue/0 group-hover:bg-suzuki-blue transition-all duration-300" />
                ...
                <div className="p-5 flex flex-col gap-2 flex-1">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-suzuki-blue font-bold text-sm tabular-nums shrink-0">{model.hpRange}</span>
                  </div>
                  <p className="text-xs text-silver-dark leading-relaxed">{model.keyFeature}</p>
                  <div className="mt-auto pt-4">
                    <Link
                      href="/contact?enquiry=Suzuki+outboard+enquiry"
                      className="flex items-center justify-between bg-white border border-charcoal/20 text-charcoal text-xs font-bold px-4 py-2.5 tracking-wide hover:bg-suzuki-blue hover:text-white hover:border-suzuki-blue transition-all duration-200 focus-visible:outline-2 focus-visible:outline-ocean focus-visible:outline-offset-2"
                    >
                      Enquire
